...
png(filename =  "plot4.png") ## Open PNG device; create 'plot1.png' in my working directory
...
with(tab1, plot(datetime, Voltage, type = "l"))
...
with(tab1, plot(datetime, Global_reactive_power, type = "l"))
